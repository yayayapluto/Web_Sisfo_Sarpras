                    ...
                    {!isLoading && (
                        <>
                            ...
                            <div className="border-1 rounded-sm p-4">
                                <div className="space-y-4">
                                    <div className="flex flex-row items-center gap-2 -">
                                        <h4 className={"text-lg"}>Return Request</h4>
                                        {borrowRequest?.return_request && (
                                            <Button variant={"outline"} className="size-6" onClick={() => navigate(`/return-requests/${borrowRequest?.return_request?.id}`)}>
                                            <ArrowUpRight />
                                        </Button>
                                        )}
                                    </div>
                                    ...
                                    {borrowRequest?.return_request ? (
                                        ...
                                        <p className="text-muted-foreground">
                                            <span className="text-black">
                                                Status:
                                            </span> {borrowRequest?.return_request?.status}
                                        </p>
                                        <p className="text-muted-foreground">
                                            <span className="text-black">
                                                Notes:
                                            </span> {borrowRequest?.return_request?.notes}
                                        </p>
                                        <p className="text-muted-foreground">
                                            <span className="text-black">
                                                Handled By:
                                            </span> {borrowRequest?.return_request?.handled_by ?? "-"}
                                        </p>
                                    </div>
                                    ) : (
                                        <p className="text-sm">There is no return request</p>
                                    )}
                                </div>
                            </div>
                        </>
