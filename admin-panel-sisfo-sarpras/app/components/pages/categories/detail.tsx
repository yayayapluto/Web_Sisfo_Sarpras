...
export default function CategoryDetail() {
    ...
    const url = `http://localhost:8000/api/admin/categories/${params.slug}`
    ...
    const {isLoading: isDeleteLoading, error: deleteError} = useApi<Category>({
        url: url,
        method: "DELETE",
        headers: {
            Authorization: `Bearer ${token}`
    ...
    return (
        <div className="container mx-auto space-y-4">
            ...
            <div className={"border-1 p-4 space-y-4"}>
                ...
                {!isLoading && (
                    <>
                        <h4 className={"text-lg font-normal"}>List items in this category</h4>
